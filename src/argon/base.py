...
def r_resolve(globalns, localns, rarg):
    match rarg:
        ...
        case typing._GenericAlias():  # type: ignore -- We don't have a great alternative way for checking if an object is a GenericAlias
            ...
            return typing._GenericAlias(typing.get_origin(rarg), tuple(inner_arg_list))  # type: ignore -- We don't have a great alternative way for generating an object that is a GenericAlias
        case _:
